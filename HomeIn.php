<?php
    ...
    $result = mysqli_query($conn, "SELECT first_name FROM user WHERE user_id='$user_id'");
...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Ready​ to find out the best job for you?, Figured what you need?">
...
<link rel="stylesheet" href="Home.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-custom-color-1 u-header u-sticky u-sticky-c86f u-header" id="sec-dcff"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-section-1" id="sec-c37a">
      <div class="u-clearfix u-sheet u-sheet-1">
          <div class="u-layout">
              <?php
                echo "<p>Welcome Back, ". htmlspecialchars($user['first_name']) ."!</p>";
              ?>
              <center>
              <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-2">
                <div class="u-border-2 u-border-grey-75 u-container-layout u-valign-top u-container-layout-2"><br>
                  <h2 class="u-custom-font u-font-montserrat u-text u-text-default u-text-3">Figured what you need?</h2><br>
                  <p class="u-custom-font u-font-montserrat u-text u-text-default u-text-4"> Students upgrade their current skills to secure their chance of being hired. Updating skills would enhance the chance of qualification.</p><br><br>
                  <a href="Syllabus.php" class="u-border-none u-btn u-button-style u-custom-font u-font-montserrat u-grey-40 u-hover-grey-25 u-text-custom-color-1 u-btn-3">Update syllabus here</a>
                </div>
              </div></center>
          </div>
      </div>
