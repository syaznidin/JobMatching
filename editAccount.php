    ...
    <section class="u-clearfix u-section-1" id="sec-4002">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-border-2 u-border-grey-75 u-form u-login-control u-form-1">
          <form action="Account.php" class="u-clearfix u-form-custom-backend u-form-spacing-0 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 20px;" method="post">
            ...
            while($row = mysqli_fetch_row($result)){
              echo " <label for='firstName' class='u-label'><br>First Name: </label><input type='text'  id='firstName' name='firstName' class='u-input u-input-rectangle u-none u-input-1' value='$row[1]'>";
              echo "<label for='lastName' class='u-label'><br>Last Name: </label><input type='text'  id='lastName' name='lastName' class='u-input u-input-rectangle u-none u-input-1' value='$row[2]'>";
              echo "<label for='birthDate' class='u-label'><br>Birth Date: </label><input type='date'  id='birthDate' name='birthDate' class='u-input u-input-rectangle u-none u-input-1' value='$row[7]'>";
              echo "<label for='email' class='u-label'><br>Email: </label><input type='text'  id='email' name='email' class='u-input u-input-rectangle u-none u-input-1' value='$row[3]'>";
              echo "<label for='phoneNum' class='u-label'><br>Phone Number: </label><input type='text'  id='phoneNum' name='phoneNum' class='u-input u-input-rectangle u-none u-input-1' value='$row[5]'>";
              echo "<label for='gender' class='u-label'><br>Gender: </label><input type='text'  id='gender' name='gender' class='u-input u-input-rectangle u-none u-input-1' value='$row[6]'>";
            }
            ...
            <input type='text'  id='password' name='password' class='u-input u-input-rectangle u-none u-input-2' value='Hidden' readonly>
              <br><a href="password.php" >Change Password</a><br>
